...
| **Two-VPS split: DEV vs PROD** | Current VPS (31.220.60.32) becomes DEV/INTERNAL — RMT portal, n8n test builds, experiments. A new Hostinger VPS becomes PROD — client production automations (kclaw, future clients). Uptime Kuma lives on DEV and monitors both. Monitoring stack ships on DEV first; PROD VPS provisioned in a dedicated later phase (after DEV stack is live and proven). | ✅ Decided 2026-05-17 |
