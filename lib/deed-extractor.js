...

{
  ...
  "grantor_name": "<full name(s) of the seller / current owner, as written>",
  "grantor_address": "<grantor's address as written on the deed>",
  "grantee_name": "<full name(s) of the buyer / new owner, as written, including form of co-ownership if stated>",
  ...
  "property_city": "<city / village / town>",
  "property_state": "<state>",
  "property_county": "<county>",
  "tax_section": "<tax map section, if shown>",
  "tax_block": "<tax map block, if shown>",
  "tax_lot": "<tax map lot, if shown>",
